...
std::pair<int, std::string> TopAndPop(skew_heap<int, std::string> &h){
	std::pair<int, std::string> x = h.top();
	h.pop();
	return x;
}

struct min_skew_heap_Test : testing::Test {
	skew_heap<int, std::string> *heap;

	min_skew_heap_Test(){
		heap = new skew_heap<int, std::string>([](int k1, int k2){ return k1 < k2;});
	}
};

TEST_F(min_skew_heap_Test, PushPop) {
...
TEST_F(min_skew_heap_Test, Merge) {

	skew_heap<int, std::string> h([](int k1, int k2){ return k1 < k2;});
...
TEST(max_skew_heap_Test, PushPop) { 
	skew_heap<int, std::string> max_heap([](int k1, int k2){ return k1 > k2;});
